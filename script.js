...
// ⚠️ IMPORTANTE: Reemplaza esta URL con la URL de tu proyecto desplegado
// en Google Apps Script (tipo "Aplicación web").
...
async function submitRegistration() {
  ...
  try {
    ...
    if (result.success) {
      ...
      messageBox.style.color = '#43A047'; // Verde éxito
